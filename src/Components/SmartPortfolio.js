...
<Select  
     ...
     { (isReactPicked  || isNodePicked || isJSPicked || isAllPicked || isEmpty) &&
<DummyPortfolio
   
                 title={"The Real Bill"}
              description={"The real cost of living worldwide"}
              descriptionApp={"App that provides information about the Living Index - theory based on the Purchasing Power Parity."}
         
              linkPicture={"url(https://images.unsplash.com/photo-1502920514313-52581002a659?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8Y3VycmVuY3l8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60)"}
    
              linkGitHub={"https://github.com/MairaGalvao/TheRealBillApp"}
              linkDemo={"https://therealbill-6c919.web.app"}
            /> }

{( isReactPicked || isEmpty)&& <DummyPortfolio
    linkGitHub={"https://github.com/MairaGalvao/Geo_Data"}
    
    title={"GEO Data"}
    description={"GEO Data Map"}
    descriptionApp={"Coming soon"}
    linkPicture={"url(https://media.istockphoto.com/photos/young-man-planning-a-road-trip-picture-id487081189?s=612x612)"}
    linkGitHub={"https://github.com/MairaGalvao/Geo_Data"}
  />}
           ...
           {(isPythonPicked || isAllPicked || isEmpty ) && <DummyPortfolio
              title={"Data analysis"}
              description={"Doneness steak data analysis"}
              descriptionApp={"A data analysis based on correlations and comparisons among the samples."}
              linkPicture={"url(https://images.unsplash.com/photo-1551809727-fa6cc87641a8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80)"}

              linkGitHub={"https://github.com/MairaGalvao/Steak_Risk_Data"}
              linkArticle={"https://medium.com/swlh/practical-data-analysis-with-pandas-and-seaborn-matplotlib-d1820ab27fd8"}
             
            />}

{(isAllPicked || isReactPicked ||isEmpty) && <DummyPortfolio
              linkPicture={"url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0d20IuUMfp3kytjSMv5YmFLKY9wMctG1AN0rwhv1kS5unmGdfifdLOMbfJzDI8NshMu0&usqp=CAU)"}  
              title={"Web Scraping"}
 ...
 <DummyPortfolio
              ...
              descriptionApp={"Serverless flashcards app that displays a quiz containing several questions on computer languages."}
...
{ (isAllPicked || isNodePicked || isJSPicked) && <DummyPortfolio

              title={"Health Care Analysis"}
              description={"An analysis of health worldwide."}
              descriptionApp={"An app that provides measurements of health care around the world."}
              linkGitHub={
...
{(isAllPicked || isPythonPicked || isReactPicked || isJSPicked )&& <DummyPortfolio
...
{(isAllPicked || isReactPicked ) && <DummyPortfolio
...
{( isAllPicked || isJSPicked ) && <DummyPortfolio
...
justifyContent: 'space-around',
          ...
          <Button variant="contained" class='seeAllBtn' onClick={seeAllBtn} style={{fontSize:'22px', cursor:'pointer'}}> See all </Button>      
