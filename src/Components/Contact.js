...
export function Contact() {
  ...
  return (
    <>
      ...
      >
           <Box style={{paddingBottom:'150px'}} className="header" data-aos="fade-down" data-aos-duration="2000">
          ...
          <form action="#" method="post" id="contact_form" onSubmit={onSubmit}>
            <div class="field" tabIndex="1">
              <label for="username" htmlFor="name">
                <i class="fa fa-user" style={{paddingRight:'10px'}}></i>Your Name
              </label>
              <input
                type="text"
                placeholder="Name"
            ...
            <div class="field" tabIndex="1">
              <label for="email">
                <i class="fa fa-envelope" style={{paddingRight:'10px'}}></i>Your Email
              </label>
              <input
                id="email_input"
                name="reply_to"
